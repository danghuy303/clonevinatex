...
import { generateGuid } from '../../services/globalfunction';
import { ModalthongbaoComponent } from '../../quantri/modal/modalthongbao/modalthongbao.component';

@Component({
  selector: 'app-dinhmucdien',
  templateUrl: './dinhmucdien.component.html',
  styleUrls: ['./dinhmucdien.component.css']
})
export class DinhmucdienComponent implements OnInit, OnChanges {
