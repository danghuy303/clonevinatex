...
import { MucLuongCoCauNhanSuModalComponent } from './muc-luong-co-cau-nhan-su-modal/muc-luong-co-cau-nhan-su-modal.component';

@Component({
  selector: 'app-muc-luong-co-cau-nhan-su',
  templateUrl: './muc-luong-co-cau-nhan-su.component.html',
  styleUrls: ['./muc-luong-co-cau-nhan-su.component.css']
})
export class MucLuongCoCauNhanSuComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(MucLuongCoCauNhanSuModalComponent,{
      backdrop:'static',
      size:'fullscreen'
    });
