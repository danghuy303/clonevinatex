...
@Component({
  selector: 'app-muc-luong-co-cau-nhan-su-modal',
  templateUrl: './muc-luong-co-cau-nhan-su-modal.component.html',
  styleUrls: ['./muc-luong-co-cau-nhan-su-modal.component.css']
})
export class MucLuongCoCauNhanSuModalComponent implements OnInit {
