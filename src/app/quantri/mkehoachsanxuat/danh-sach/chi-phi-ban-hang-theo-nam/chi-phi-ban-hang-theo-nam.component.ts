...
import { ChiPhiBanHangTheoNamModalComponent } from './chi-phi-ban-hang-theo-nam-modal/chi-phi-ban-hang-theo-nam-modal.component';

@Component({
  selector: 'app-chi-phi-ban-hang-theo-nam',
  templateUrl: './chi-phi-ban-hang-theo-nam.component.html',
  styleUrls: ['./chi-phi-ban-hang-theo-nam.component.css']
})
export class ChiPhiBanHangTheoNamComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(ChiPhiBanHangTheoNamModalComponent,{
      backdrop:'static',
      size:'fullscreen'
    });
