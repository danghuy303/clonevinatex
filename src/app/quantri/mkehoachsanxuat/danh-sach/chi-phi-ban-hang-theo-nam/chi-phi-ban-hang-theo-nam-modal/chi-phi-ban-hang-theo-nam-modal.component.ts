...
@Component({
  selector: 'app-chi-phi-ban-hang-theo-nam-modal',
  templateUrl: './chi-phi-ban-hang-theo-nam-modal.component.html',
  styleUrls: ['./chi-phi-ban-hang-theo-nam-modal.component.css']
})
export class ChiPhiBanHangTheoNamModalComponent implements OnInit {
