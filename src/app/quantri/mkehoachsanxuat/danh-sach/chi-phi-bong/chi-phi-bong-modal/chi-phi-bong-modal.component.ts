...
@Component({
  selector: 'app-chi-phi-bong-modal',
  templateUrl: './chi-phi-bong-modal.component.html',
  styleUrls: ['./chi-phi-bong-modal.component.css']
})
export class ChiPhiBongModalComponent implements OnInit {
