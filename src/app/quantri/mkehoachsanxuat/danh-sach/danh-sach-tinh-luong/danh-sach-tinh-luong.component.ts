...
import { DanhSachTinhLuongModalComponent } from './danh-sach-tinh-luong-modal/danh-sach-tinh-luong-modal.component';

@Component({
  selector: 'app-danh-sach-tinh-luong',
  templateUrl: './danh-sach-tinh-luong.component.html',
  styleUrls: ['./danh-sach-tinh-luong.component.css']
})
export class DanhSachTinhLuongComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(DanhSachTinhLuongModalComponent,{
      backdrop:'static',
      size:'fullscreen-100'
    });
