...
@Component({
  selector: 'app-danh-sach-tinh-luong-modal',
  templateUrl: './danh-sach-tinh-luong-modal.component.html',
  styleUrls: ['./danh-sach-tinh-luong-modal.component.css']
})
export class DanhSachTinhLuongModalComponent implements OnInit {
