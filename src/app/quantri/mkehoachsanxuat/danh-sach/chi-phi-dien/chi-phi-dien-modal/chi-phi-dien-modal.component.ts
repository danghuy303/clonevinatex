...
@Component({
  selector: 'app-chi-phi-dien-modal',
  templateUrl: './chi-phi-dien-modal.component.html',
  styleUrls: ['./chi-phi-dien-modal.component.css']
})
export class ChiPhiDienModalComponent implements OnInit {
