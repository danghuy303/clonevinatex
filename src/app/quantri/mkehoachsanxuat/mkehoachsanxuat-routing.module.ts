...
import { MucluongcocaunhansuComponent } from '../hopdong/danhsach/mucluongcocaunhansu/mucluongcocaunhansu/mucluongcocaunhansu.component';
...
const routes: Routes = [
  ...
  { path: 'danhmuc/vattuphu/:id', component: VatTuPhuComponent },
  ...
  { path: 'dinhmucsanxuat/:id', component: DinhMucMatHangComponent },
  ...
  // { path: 'danhmuc/chiphibanhangtheoban/:id', component: ChiPhiBanHangComponent },
];
