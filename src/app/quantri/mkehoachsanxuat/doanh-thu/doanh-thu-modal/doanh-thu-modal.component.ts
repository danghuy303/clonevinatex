...
@Component({
  selector: 'app-doanh-thu-modal',
  templateUrl: './doanh-thu-modal.component.html',
  styleUrls: ['./doanh-thu-modal.component.css']
})
export class DoanhThuModalComponent implements OnInit {
