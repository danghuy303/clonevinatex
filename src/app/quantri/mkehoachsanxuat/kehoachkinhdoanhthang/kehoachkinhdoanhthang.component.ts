...
import { ChitietkehoachthangmodalComponent } from './chitietkehoachthangmodal/chitietkehoachthangmodal.component';
...
export class KehoachkinhdoanhthangComponent implements OnInit {
  ...
  add() {
    let modalRef = this._modal.open(ChitietkehoachthangmodalComponent, {
      backdrop: 'static',
      size: 'fullscreen-100',
      keyboard:true
    });
