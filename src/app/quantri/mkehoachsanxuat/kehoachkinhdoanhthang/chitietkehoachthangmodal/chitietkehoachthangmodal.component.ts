...
@Component({
  selector: 'app-chitietkehoachthangmodal',
  templateUrl: './chitietkehoachthangmodal.component.html',
  styleUrls: ['./chitietkehoachthangmodal.component.css']
})
export class ChitietkehoachthangmodalComponent implements OnInit {
