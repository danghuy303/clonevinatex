...
@Component({
  selector: 'app-ty-gia-ngoai-te-modal',
  templateUrl: './ty-gia-ngoai-te-modal.component.html',
  styleUrls: ['./ty-gia-ngoai-te-modal.component.css']
})
export class TyGiaNgoaiTeModalComponent implements OnInit {
