...
import {TyGiaNgoaiTeModalComponent} from './ty-gia-ngoai-te-modal/ty-gia-ngoai-te-modal.component'

@Component({
  selector: 'app-ty-gia-ngoai-te',
  templateUrl: './ty-gia-ngoai-te.component.html',
  styleUrls: ['./ty-gia-ngoai-te.component.css']
})
export class TyGiaNgoaiTeComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(TyGiaNgoaiTeModalComponent,{
      backdrop:'static',
      size:'fullscreen'
    });
