...
import{ChiPhiBanHangModalComponent} from './chi-phi-ban-hang-modal/chi-phi-ban-hang-modal.component'

@Component({
  selector: 'app-chi-phi-ban-hang',
  templateUrl: './chi-phi-ban-hang.component.html',
  styleUrls: ['./chi-phi-ban-hang.component.css']
})
export class ChiPhiBanHangComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(ChiPhiBanHangModalComponent,{
      backdrop:'static'
    });
