...
@Component({
  selector: 'app-chi-phi-ban-hang-modal',
  templateUrl: './chi-phi-ban-hang-modal.component.html',
  styleUrls: ['./chi-phi-ban-hang-modal.component.css']
})
export class ChiPhiBanHangModalComponent implements OnInit {
