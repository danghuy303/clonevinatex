...
@Component({
  selector: 'app-tai-san-modal',
  templateUrl: './tai-san-modal.component.html',
  styleUrls: ['./tai-san-modal.component.css']
})
export class TaiSanModalComponent implements OnInit {
