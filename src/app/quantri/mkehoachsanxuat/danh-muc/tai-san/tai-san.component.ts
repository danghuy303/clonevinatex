...
import { TaiSanModalComponent } from './tai-san-modal/tai-san-modal.component';

@Component({
  selector: 'app-tai-san',
  templateUrl: './tai-san.component.html',
  styleUrls: ['./tai-san.component.css']
})
export class TaiSanComponent implements OnInit {
  ...
  add() {
    let modalRef = this._modal.open(TaiSanModalComponent, {
      backdrop: 'static',
      size: 'lg',
    });
    modalRef.componentInstance.opt = 'add';
    modalRef.componentInstance.type = 'themmoi';
    modalRef.componentInstance.title = 'Thêm mới máy/thiết bị';
