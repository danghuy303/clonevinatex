...
@Component({
  selector: 'app-vat-tu-phu-modal',
  templateUrl: './vat-tu-phu-modal.component.html',
  styleUrls: ['./vat-tu-phu-modal.component.css']
})
export class VatTuPhuModalComponent implements OnInit {
