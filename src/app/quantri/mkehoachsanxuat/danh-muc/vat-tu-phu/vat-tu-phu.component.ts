...
import { VatTuPhuModalComponent } from './vat-tu-phu-modal/vat-tu-phu-modal.component';

@Component({
  selector: 'app-vat-tu-phu',
  templateUrl: './vat-tu-phu.component.html',
  styleUrls: ['./vat-tu-phu.component.css']
})
export class VatTuPhuComponent implements OnInit {
  ...
  add(){
    let modalRef = this._modal.open(VatTuPhuModalComponent,{
      backdrop:'static'
    });
