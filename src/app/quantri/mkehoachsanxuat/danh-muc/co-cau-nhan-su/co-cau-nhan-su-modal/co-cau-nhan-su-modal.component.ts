...
@Component({
  selector: 'app-co-cau-nhan-su-modal',
  templateUrl: './co-cau-nhan-su-modal.component.html',
  styleUrls: ['./co-cau-nhan-su-modal.component.css']
})
export class CoCauNhanSuModalComponent implements OnInit {
