...
@Component({
  selector: 'app-don-gia-san-pham-modal',
  templateUrl: './don-gia-san-pham-modal.component.html',
  styleUrls: ['./don-gia-san-pham-modal.component.css']
})
export class DonGiaSanPhamModalComponent implements OnInit {
  ...
  constructor(
    ...
    public _hopdongServices:HopDongService
  ) { }
