...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "quantrisanxuat/nhucauxuathang",
        component: NhucauxuathangComponent,
      },
      { path: "quantrisanxuat/sanluong", component: SanluongComponent },
      {
        path: "quantrisanxuat/tonghop",
        component: DieuhanhsanxuattonghopComponent,
      },
      { path: "quantrisanxuat/chatluong", component: DieuhanhsanxuatComponent },
      {
        path: "quantrisanxuat/thongluong",
        component: DashboardthongluongComponent,
      },
      {
      ...
      {
        path: "baocaosanxuat/sanluongchitiet",
        component: SanluongchitietComponent,
      },
      ...
      { path: "danhmucsanxuat/dmkiemkebcp", component: DmKiemKeBanChePhamComponent },
      {
        path: "danhmucsanxuat/dmtieuchichatluongsoi",
        component: DmtieuchichatluongsoiComponent,
      },
      {
        path: "danhmucsanxuat/dmphannhommay",
        component: DmphannhommayComponent,
      },
      {
        path: "danhmucsanxuat/dmquycachdonggoi",
        component: QuycachdonggoiComponent,
      },
      {
        path: "danhmucsanxuat/dmthongkedien/:id",
        component: DmthongkedienComponent,
      },
      {
        path: "danhmucsanxuat/dmdinhmucchatluongsoi",
        component: DinhmuctieuchichatluongsoiComponent,
      },
      {
        path: "danhmucsanxuat/dmdinhmuctieuhao",
        component: DinhmuctieuhaoComponent,
      },
      { path: "danhmucsanxuat/dmvitri", component: VitriComponent },
      {
        path: "danhmucsanxuat/dmloaibongphe",
        component: LoaiBongPheDanhMucComponent,
      },
      {
        path: "danhmucsanxuat/tyletieuchuanbongphe",
        component: TyLeTieuChuanBongPheComponent,
      },
      {
        path: "danhmucsanxuat/tyletieuchuanbonghoi",
        component: TyLeTieuChuanBongHoiComponent,
      },
      {
        path: "theodoithongkebaocaosanxuat/thongkedien/:id",
        component: DmthongkedienComponent,
      },
      {
      ...
      { path: "danhmucsanxuat/dmhethongdieukhong", component: DmHeThongDieuKhongComponent },
      { path: "danhmucsanxuat/dmkhuvucdieukhong", component: DmKhuVucDieuKhongComponent },
      { path: "danhmucsanxuat/dmcaphutdieukhong", component: DmCapHutDieuKhongComponent },

      {
        path: "theodoithongkebaocaosanxuat/thongkesanluong/:id",
        component: ThongkesanluongComponent,
      },
      {
        path: "theodoithongkebaocaosanxuat/thongkesanluongca/:id",
        component: ThongkesanluongcaComponent,
      },
      ...
      //XepBanBong
      {
        path: "trienkhaisanxuat/xepbanbong/:id",
        component: XepbanbongComponent,
      },

      {
        path: "trienkhaisanxuat/phieudieuchinh/:id",
        component: PhieudieuchinhComponent,
      },

      {
        path: "quanlykhosanxuat/khobong/nhapkho/:id",
        component: NhapkhoComponent,
      },
      {
        path: "quanlykhosanxuat/khoxo/nhapkho/:id",
        component: NhapkhoxoComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/thongsochatluong/:id",
        component: ThongsochatluongComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/xuatkho/:id",
        component: XuatkhoComponent,
      },
      {
        path: "quanlykhosanxuat/:kho/kiemkekho/:id",
        component: KiemkekhoComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/dieuchuyen/:id",
        component: DieuchuyenComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/kehoachnhapnguyenlieu/:id",
        component: KehoachnhapnguyenlieuComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/kehoachnhapnguyenlieuinvoice/:id",
        component: KehoachnhapnguyenlieuinvoiceComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/candoiton/:id",
        component: CandoitonComponent,
      },

      {
        path: "quanlykhosanxuat/khoxo/xuatkho/:id",
        component: XuatkhoxoComponent,
      },
      {
        path: "quanlykhosanxuat/khoxo/dieuchuyen/:id",
        component: DieuchuyenComponent,
      },
      {
        path: "quanlykhosanxuat/khoxo/kehoachnhapnguyenlieu/:id",
        component: KehoachnhapnguyenlieuComponent,
      },

      {
        path: "quanlysanxuatkhohoiam/khohoiam/nhapkho/:id",
        component: NhapkhohoiamComponent,
      },
      {
        path: "quanlysanxuatkhohoiam/khohoiam/hacap/:id",
        component: HacapComponent,
      },
      {
        path: "quanlysanxuatkhohoiam/khohoiam/chatluongsoi/:id",
        component: ChatluongsoiComponent,
      },
      {
        path: "quanlysanxuatkhohoiam/quanlysanxuatkhohoiam/kiemkekho/:id",
        component: HoiamkiemkekhoComponent,
      },
      {
        path: "quanlykhosanxuat/tonkho/khohoiam/:id",
        component: TonkhohoiamComponent,
      },
      {
      ...
      {
        path: "quanlykhosanxuatbong/khohoiluongdo/xuatkho/:id",
        component: XuatkhohoiluongdoComponent,
      },
      {
        path: "quanlykhosanxuatbong/khohoiluongdo/kiemke/:id",
        component: KiemkekhohoiluongdoComponent,
      },
      {
        path: "quanlykhosanxuatbong/tonkhobonghoi/khobonghoi/:id",
        component: TonkhohoiluongdoComponent,
      },

      {
        path: "quanlykhosanxuatbongkhac/khobonghoi/nhapkho/:id",
        component: NhapkhokhacComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khobonghoi/xuatkho/:id",
        component: XuatkhobonghoiComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khobonghoi/kiemkekho/:id",
        component: KiemkekhoComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khobonghoi/dieuchuyen/:id",
        component: DieuchuyenComponent,
      },

      {
        path: "quanlykhosanxuatbongkhac/khobongphe/nhapkho/:id",
        component: NhapkhobongpheComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khobongphe/xuatkho/:id",
        component: XuatkhobongpheComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khobongphe/kiemkekho/:id",
        component: KiemkekhoComponent,
      },

      {
        path: "quanlysanxuatkhothanhpham/khothanhpham/nhapkho/:id",
        component: NhapkhothanhphamComponent,
      },
      {
        path: "quanlysanxuatkhothanhpham/khothanhpham/kiemkekho/:id",
        component: KiemkekhoComponent,
      },
      {
        path: "quanlysanxuatkhothanhpham/khothanhpham/kehoachxuathang/:id",
        component: KehoachxuathangComponent,
      },
      {
        path: "quanlysanxuatkhothanhpham/khothanhpham/xuatkhothanhpham/:id",
        component: XuatkhothanhphamComponent,
      },

      {
        path: "kehoachsanxuat/giaokehoachsanxuat/:id",
        component: KehoachsanxuatComponent,
      },
      {
        path: "kehoachsanxuat/giaokehoachsanxuathoanthanh/:id",
        component: GiaokehoachsanxuathoanthanhComponent,
      },
      {
        path: "kehoachsanxuat/trienkhaikehoachsanxuat/:id",
        component: TrienkhaikehoachsanxuatComponent,
      },
      { path: "kehoachsanxuat/candoichuyen", component: CandoichuyenComponent },

      {
        path: "phanquyensanxuat/phanquyentheophanxuong",
        component: PhanquyentheophanxuongComponent,
      },
      ...
      {
        path: "quanlykhosanxuat/khobong/kiemkekhobong/:id",
      ...
      {
        path: "quanlykhosanxuat/khobonghoi/kiemkekhobonghoi/:id",
        component: KhobonghoikiemkekhoComponent,
      },
      {
        path: "quanlykhosanxuat/khobongphe/kiemkekhobongphe/:id",
        component: KhobongphekiemkekhoComponent,
      },
      {
        path: "quanlykhosanxuat/tonkhobongxo/:kho/:id",
        component: TonkhobongxoComponent,
      },
      {
        path: "quanlykhosanxuat/tonkhobonghoi/khobonghoi/:id",
        component: TonkhobonghoiComponent,
      },
      {
        path: "quanlykhosanxuat/tonkhobongphe/khobongphe/:id",
        component: TonkhobongpheComponent,
      },
      { path: "quanlykhosanxuat/hdsd", component: UploadhdsdsanxuatComponent },
      {
        path: "phanquyensanxuat/dmchisotrienkhai",
        component: DmchisotrienkhaiComponent,
      },
      { path: "phanquyensanxuat/dmkgcone", component: DmkgconeComponent },
      {
        path: "hopdongsanxuat",
        loadChildren: () =>
          import("./hopdong/hopdong.module").then((m) => m.HopdongModule),
      },
      {
        path: "mkehoachsanxuat",
        loadChildren: () =>
          import("./mkehoachsanxuat/mkehoachsanxuat.module").then(
            (m) => m.MkehoachsanxuatModule
          ),
      },
      {
        path: "taisan",
        loadChildren: () =>
          import("./taisan/taisan.module").then((m) => m.TaisanModule),
      },
      {
        path: "baocaotonghop",
        loadChildren: () =>
          import("./bao-cao-tong-hop/bao-cao-tong-hop.module").then(
...

      {
        ...
        component: NhapkhovattuphuComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khovattuphu/xuatkho/:id",
        component: XuatkhovattuphuComponent,
      },
      {
        path: "quanlykhosanxuatbongkhac/khovattuphu/kiemkekho/:id",
        component: KiemkekhovattuphuComponent,
      },
      {
        path: "quanlykhosanxuat/xuatbongchovay/khobong/:id",
        component: XuatbongchovayComponent,
      },
      {
        path: "quanlykhosanxuat/khobong/kiemtrabanchepham/:id",
        component: KiemtrabanchephamComponent,
      },
      {
