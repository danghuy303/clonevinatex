...
@Component({
  selector: 'app-modaldmloicat',
  templateUrl: './modaldmloicat.component.html',
  styleUrls: ['./modaldmloicat.component.css']
})
export class ModaldmloicatComponent implements OnInit {
  public item: any = {};
  public title: any = '';
  public type = '';
  opt: any = "";
  ...
  Save() {
    this.sanXuatService.DanhMucLoiCat().Set(this.item).subscribe((res: any) => {
      if (res) {
        this.resAction(res)
      }
    })
