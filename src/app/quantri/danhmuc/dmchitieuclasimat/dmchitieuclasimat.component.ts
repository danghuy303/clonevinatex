...
import { ModaldmclassimatComponent } from '../modal/modaldmclassimat/modaldmclassimat.component';

@Component({
  selector: 'app-dmchitieuclasimat',
  templateUrl: './dmchitieuclasimat.component.html',
  styleUrls: ['./dmchitieuclasimat.component.css']
})
export class DmchitieuclasimatComponent implements OnInit {
  ...
  GetListDanhMuc(reset?){
    ...
    this._services.DanhMucClassimat().GetList(data).subscribe((res:any)=>{
  ...
  add(){
    let modalRef = this._modal.open(ModaldmclassimatComponent,{
      backdrop:'static'
    });
    modalRef.componentInstance.opt='add';
    modalRef.componentInstance.title = 'Thêm mới danh mục chỉ tiêu classimat';
  ...
  edit(item){
    ...
    modalRef.componentInstance.title = 'Cập nhật danh mục chỉ tiêu classimat';
