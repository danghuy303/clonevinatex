...
@Component({
  ...
  templateUrl: './chi-tiet-kiem-kho-vat-tu.component.html',
  styleUrls: ['./chi-tiet-kiem-kho-vat-tu.component.css']
})
export class ChiTietKiemKhoVatTuComponent implements OnInit {
