...
@Component({
  selector: 'app-tonghopdondathangncc',
  templateUrl: './tonghopdondathangncc.component.html',
  styleUrls: ['./tonghopdondathangncc.component.css']
})
export class TonghopdondathangnccComponent implements OnInit {
  ...
  GetList(reset?) {
    ...
    this._serviceTaiSan.TongHopDatHang(data).subscribe((res: any) => {
