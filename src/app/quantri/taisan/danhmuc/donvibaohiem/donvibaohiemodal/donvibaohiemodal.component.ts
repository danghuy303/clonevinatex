...
@Component({
  selector: 'app-donvibaohiemodal',
  templateUrl: './donvibaohiemodal.component.html',
  styleUrls: ['./donvibaohiemodal.component.css']
})
export class DonvibaohiemodalComponent implements OnInit {
  ...
  GhiLai() {
    if (this.ValidateData()) {
      this._danhMucTaiSan.DonViBaoHiem().Set(this.item).subscribe((res: any) => {
