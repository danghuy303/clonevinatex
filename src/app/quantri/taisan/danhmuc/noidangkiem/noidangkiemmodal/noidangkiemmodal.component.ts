...
@Component({
  selector: 'app-noidangkiemmodal',
  templateUrl: './noidangkiemmodal.component.html',
  styleUrls: ['./noidangkiemmodal.component.css']
})
export class NoidangkiemmodalComponent implements OnInit {
  ...
  GhiLai() {
    if (this.ValidateData()) {
      this._danhMucTaiSan.NoiDangKiem().Set(this.item).subscribe((res: any) => {
