...
@Component({
  selector: 'app-loaihinhbaohiemmodal',
  templateUrl: './loaihinhbaohiemmodal.component.html',
  styleUrls: ['./loaihinhbaohiemmodal.component.css']
})
export class LoaihinhbaohiemmodalComponent implements OnInit {
  ...
  GhiLai() {
    if (this.ValidateData()) {
      this._danhMucTaiSan.LoaiHinhBaoHiem().Set(this.item).subscribe((res: any) => {
