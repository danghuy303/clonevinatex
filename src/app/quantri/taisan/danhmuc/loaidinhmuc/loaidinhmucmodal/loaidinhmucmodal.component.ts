...
@Component({
  selector: 'app-loaidinhmucmodal',
  templateUrl: './loaidinhmucmodal.component.html',
  styleUrls: ['./loaidinhmucmodal.component.css']
})
export class LoaidinhmucmodalComponent implements OnInit {
  ...
  GhiLai() {
    if (this.ValidateData()) {
      this._danhMucTaiSan.LoaiDinhMucNhienLieu().Set(this.item).subscribe((res: any) => {
