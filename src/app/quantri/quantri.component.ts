...
export class QuantriComponent implements OnInit, OnDestroy {
    ...
    this.menuQLNS = [
      {
        ...
        items: [
          ...
          {
            label: "Tổng hợp dashboard",
            routerLink: "/quantri/quantrisanxuat/dashboardtonghop",
            separator: this.checkmenu("DASHBOARD_TONGHOP"),
            icon: "fas fa-circle",
            command: () => {
              this.close();
      ...
      //           routerLink: "/quantri/taisan/kiem-ke-kho-vat-tu/0",
      //           command: () => {
      //             this.close();
      //           },
      //         },
      //         {
      //           label: "Thẻ kho vật tư",
      //           routerLink: "/quantri/taisan/the-kho-vat-tu",
      //           command: () => {
      //             this.close();
      //           },
      //         },
...

      {
        ...
        icon: "fas fa-warehouse",
        visible: this.permissions?.includes('P_QUYETTOANNGUYENLIEU'),
        items: [
          {
            label: "Tổng hợp",
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Thống kê chỉ tiêu lỗi cắt theo máy",
            routerLink: "/quantri/theodoithongkebaocaosanxuat/thongkechitieuloicattheomay/0",
            command: () => this.close(),
          },
          {
            label: "Thống kê chỉ tiêu classimat theo máy",
            routerLink: "/quantri/theodoithongkebaocaosanxuat/thongkechitieuclassimattheomay/0",
            command: () => this.close(),
          },
          {
            label: "Báo cáo ca",
      ...
      {
        label: "Quản lý kho bán chế phẩm",
        icon: "fas fa-box",
        routerLink: "/quantri",
        expanded: false,
        items: [
          {
            ...
            items: [
              ...
              {
                label: "Xuất kho cấp đậu",
                routerLink: "/quantri/quanlysanxuat/khocapdau/xuatkho/0",
                separator: this.checkmenu("NHAPTHANHPHAM"),
                command: () => this.close(),
              },
              {
          ...
          },
          {
            ...
            expanded: false,
            visible: this.permissions?.includes('P_CHAIPE'),
            items: [
              {
                label: "Nhập kho",
                routerLink:
                  "/quantri/hopdongsanxuat/khotho/nhapkho/0",
                visible: this.permissions?.includes('PHIEUNHAPCHAIPE'),
                command: () => this.close(),
              },
              {
                label: "Xuất kho",
                ...
                visible: this.permissions?.includes('PHIEUXUATCHAIPE'),
                command: () => this.close(),
              },
              {
                label: "Kiểm kê kho",
                ...
                visible: this.permissions?.includes('PHIEUKIEMKECHAIPE'),
                command: () => this.close(),
              },
              {
                label: "Thẻ kho",
            ...
            items: [
              {
                label: "Nhập kho",
                routerLink:
                  "/quantri/hopdongsanxuat/khochaiky/nhapkho/0",
                visible: this.permissions?.includes('PHIEUNHAPCHAIKY'),
                command: () => this.close(),
              },
              {
                label: "Xuất kho",
                routerLink:
                  "/quantri/hopdongsanxuat/khochaiky/xuatkho/0",
                visible: this.permissions?.includes('PHIEUXUATCHAIKY'),
                command: () => this.close(),
              },
              {
                label: "Kiểm kê kho",
                routerLink:
                  "/quantri/hopdongsanxuat/khochaiky/kiemkekho/0",
                visible: this.permissions?.includes('PHIEUKIEMKECHAIKY'),
                command: () => this.close(),
              }
            ],
          },
      ...
      // },
      {
        ...
        items: [
          ...
          {
            label: "Mức lương cơ cấu nhân sự",
            routerLink: "/quantri/mkehoachsanxuat/danhsach/mucluongcocaunhansu/0",
            command: () => this.close(),
          },
          {
            label: "Chi phí bán hàng theo năm",
            routerLink: "/quantri/mkehoachsanxuat/danhsach/chiphibanhangtheonam/0",
            command: () => this.close(),
          },
          {
          ...
          // },
          // {
          //   label: "Báo cáo nhu cầu sử dụng bông",
          //   routerLink: "/quantri/mkehoachsanxuat/baocaonhucausudungbong",
          //   command: () => this.close(),
          // },
          {
            label: "Báo cáo nhu cầu định mức",
            routerLink: "/quantri/mkehoachsanxuat/baocaonhucau",
            command: () => this.close(),
          },
        ]
      },
      ...
      },
      {
        ...
        items: [
          ...
          // },
          {
            label: " Bảng giá sợi năm",
            routerLink: "/quantri/lap-ke-hoach/danhsachbanggiasoi/0",
            command: () => this.close(),
          },
          {
            label: "Bảng giá chi phí năm",
            routerLink: "/quantri/lap-ke-hoach/danhsachbanggia/0",
            command: () => this.close(),
          },
          {
            label: "Kế hoạch năm",
      ...
      },
      {
        ...
        command: () => {
          ...
          window.open(`${host}/tuhoso/#/tuhoso/`)
        },
      },
      {
        label: "Sửa HDSD",
  ...
  CaiMeNuQLTS() {
    this.menuQLTS = [
      ...
      // {
      //   label: "Quản lý kho vật tư",
      //   separator: this.checkmenu("KHOVATTU"),
      //   items: [
      //     {
      //       label: "Danh sách nhập vật tư ",
      //       routerLink: "/quantri/taisan/danhsachvattu",
