...
import { DateToUnix, UnixToDate, deepCopy, mapArrayForDropDown, validVariable } from '../../../../services/globalfunction';
...
export class KhobonghoikiemkekhomodalComponent implements OnInit, AfterViewInit, AfterViewChecked {
    ...
    listdmKho: any = []; // 6
    listdmKhoBP: any = []; // 7
    listdmKhoHoiLD: any = []; // 6
    listdmKhoHoiLD_ByDuAn: any = []; // 6
    listdmViTri: any = [];
    listLoBong: any = [];
    listLoHang: any = [];
    listLoaiBong: any = [];
    ...
    ngOnInit(): void {
        ...
        this.services.GetListdmKho({
            ...
            if (!this.item.IddmKho) {
                this.item.IddmKho = this.listdmKho[0].value;
            }
        });
        this.services.GetListdmKho({
            ...data,
            ...
            if (!this.item.IddmKho) {
                this.item.IddmKho = this.listdmKhoBP[0].value;
            }
        });
        this.services.GetListdmKho({
            ...data,
            ...
            this.listdmKhoHoiLD = mapArrayForDropDown(res, "Ten", "Id");
            if (!this.item.IddmKhoHoiLuongDo) {
                this.item.IddmKhoHoiLuongDo = this.listdmKhoHoiLD[0].value;
                if (this.listItem?.length === 0 && this.opt !== "edit") {
