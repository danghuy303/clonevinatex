...
@Component({
  selector: 'app-tonkhohoiluongdomodal',
  templateUrl: './tonkhohoiluongdomodal.component.html',
  styleUrls: ['./tonkhohoiluongdomodal.component.css']
})
export class TonkhohoiluongdomodalComponent implements OnInit {
