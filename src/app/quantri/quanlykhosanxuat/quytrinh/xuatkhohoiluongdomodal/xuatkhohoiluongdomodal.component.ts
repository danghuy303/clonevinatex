...
@Component({
  selector: 'app-xuatkhohoiluongdomodal',
  templateUrl: './xuatkhohoiluongdomodal.component.html',
  styleUrls: ['./xuatkhohoiluongdomodal.component.css']
})
export class XuatkhohoiluongdomodalComponent implements OnInit {
