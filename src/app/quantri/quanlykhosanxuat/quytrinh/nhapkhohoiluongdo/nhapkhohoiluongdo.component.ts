...
import { NhapkhohoiluongdomodalComponent } from '../nhapkhohoiluongdomodal/nhapkhohoiluongdomodal.component';

@Component({
  selector: 'app-nhapkhohoiluongdo',
  templateUrl: './nhapkhohoiluongdo.component.html',
  styleUrls: ['./nhapkhohoiluongdo.component.css']
})
export class NhapkhohoiluongdoComponent extends StoreBase implements OnInit, OnDestroy {
  ...
  changeParam(id) {
    ...
    this.router.navigate([`quantri/quanlykhosanxuatbong/khohoiluongdo/nhapkho/${id}`], { replaceUrl: true })
  }
  ...
  update(Id) {
    this._service.QuyTrinhPhieuNhapLoBong().Get(Id).subscribe((res1: any) => {
      let modalRef = this._modal.open(NhapkhohoiluongdomodalComponent, {
        size: 'fullscreen',
        backdrop: 'static'
      })
