...
@Component({
  selector: 'app-kiem-ke-kho-gia-cong-modal',
  templateUrl: './kiem-ke-kho-gia-cong-modal.component.html',
  styleUrls: ['./kiem-ke-kho-gia-cong-modal.component.css']
})
export class KiemKeKhoGiaCongModalComponent implements OnInit, AfterViewInit, AfterViewChecked {
