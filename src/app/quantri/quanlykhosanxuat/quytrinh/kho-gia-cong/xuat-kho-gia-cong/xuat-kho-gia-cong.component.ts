...
import { XuatKhoGiaCongModalComponent } from './xuat-kho-gia-cong-modal/xuat-kho-gia-cong-modal.component';

@Component({
  selector: 'app-xuat-kho-gia-cong',
  templateUrl: './xuat-kho-gia-cong.component.html',
  styleUrls: ['./xuat-kho-gia-cong.component.css']
})
export class XuatKhoGiaCongComponent extends StoreBase implements OnInit, OnDestroy {
  ...
  changeParam(id) {
    ...
    this.router.navigate([`quantri/quanlysanxuatkhogiacong/khogiacong/xuatkho/${id}`], { replaceUrl: true })
  }
