...
@Component({
  selector: 'app-cnnamdinhpx1',
  templateUrl: './cnnamdinhpx1.component.html',
  styleUrls: ['./cnnamdinhpx1.component.css']
})
export class Cnnamdinhpx1Component implements OnInit {
  checkbutton: any = {
    Ghi: false
  };
  listLoBong: any = [];
