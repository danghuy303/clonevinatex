...
@Component({
  selector: 'app-phucuong',
  templateUrl: './phucuong.component.html',
  styleUrls: ['./phucuong.component.css']
})
export class PhucuongComponent implements OnInit {
  checkbutton: any = {
    Ghi: false
  };
  listLoBong: any = [];
  ...
  renderBanDau() {
    ...
    this.block1 = this.block1.reverse();
    this.block2 = this.block2.reverse();
    this.block3 = this.block3.reverse();
    this.block4 = this.block4.reverse();
    console.log(this.block1, this.block2, this.block3, this.block4);
  ...
  getNextFocus() {
    ...
    console.log(this.focusedSlot)
    if ((this.focusedSlot + 1) <= (this.length + this.item.SoViTriNgoaiQuan)) {
      this.focusedSlot++
