...
import { ThongkesanluongnhanhmodalComponent } from '../thongkesanluongnhanhmodal/thongkesanluongnhanhmodal.component';

@Component({
  selector: 'app-thongkesanluongnhanh',
  templateUrl: './thongkesanluongnhanh.component.html',
  styleUrls: ['./thongkesanluongnhanh.component.css']
})
export class ThongkesanluongnhanhComponent implements OnInit {
  ...
  changeParam(id) {
    ...
    this.router.navigate([`quantri/theodoithongkebaocaosanxuat/thongkesanluongnhanh/${id}`], { replaceUrl: true })
  }
  add() {
    this.changeParam(0);
  ...
  GetListQuyTrinh(reset?) {
    ...
    this._service.ThongKeSanLuongNhanh().GetList(data).subscribe((res: any) => {
